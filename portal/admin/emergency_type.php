            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Adicionar Categorias de Emergência</h4>
                    </div>
                </div>
                <?php if (get("success")): ?>
                    <div>
                        <?= App::message("success", "A Emergência foi adicionada com sucesso!") ?>
                    </div>
                <?php endif; ?>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-5 col-5">
                        <h4 class="page-title">Todas Categorias de Emergência</h4>
                    </div>
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_department"><i class="fa fa-trash-o m-r-5"></i> Apagar</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body text-center">
                        ...
                        <h3>Tem certeza de que deseja excluir este tipo de Emergência?</h3>
                        <div class="m-t-20"> <a href="#" class="btn btn-white" data-dismiss="modal">Fechar</a>
                            <a href="delete_type.php?id=<?= $row['id'] ?>" class="btn btn-danger">Apagar</a>
