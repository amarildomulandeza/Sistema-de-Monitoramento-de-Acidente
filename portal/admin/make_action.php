            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        ?>
                            <li class="active">
                                <a href="view-emergency.php"><i class="fa fa-file"></i> <span>Ver Emergência</span> <span class="badge badge-pill bg-primary float-right"><?php echo $row['total']; ?></span></a>
                            </li>
                        <?php } ?>
                        <li>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Detalhes da Emergência</h4>
                    </div>
                </div>
                <?php if (get("success")): ?>
                    <div>
                        ...
                        ?>
                            <form action="update_status.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="m-t-20 text-center">
                                    <button class="btn btn-primary submit-btn">Actualizar Estado</button>
                                </div>
