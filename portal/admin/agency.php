            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Todas Agências</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-agency.php" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Adicionar Agências</a>
                    </div>

                </div>
                <?php if (get("success")): ?>
                    <div>
                        <?= App::message("success", "Agência excluída com sucesso do banco de dados!") ?>
                    </div>
                <?php endif; ?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="see-all">
                            <span class="see-all-btn">Exibindo
