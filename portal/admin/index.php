						...
						?>
							<div class="dash-widget">
								...
								<div class="dash-widget-info text-right">
									...
									<span class="widget-title1">Emergência <i class="fa fa-check" aria-hidden="true"></i></span>
								</div>
							</div>
						<?php } ?>
					</div>
					...
					<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
						...
						?>
							<div class="dash-widget">
								...
								<div class="dash-widget-info text-right">
									<h3><?php echo $row['total']; ?></h3>
									<span class="widget-title2">Usuários <i class="fa fa-check" aria-hidden="true"></i></span>
								</div>
							</div>
						<?php } ?>
					</div>
					...
					<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
						...
						?>
							<div class="dash-widget">
								...
								<div class="dash-widget-info text-right">
									<h3><?php echo $row['total']; ?></h3>
									<span class="widget-title3">Agências <i class="fa fa-check" aria-hidden="true"></i></span>
								</div>
							</div>
						<?php } ?>
					</div>
					<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
						...
						?>
							<div class="dash-widget">
								...
								<div class="dash-widget-info text-right">
									<h3><?php echo $row['total']; ?></h3>
									<span class="widget-title4">Pendentes <i class="fa fa-check" aria-hidden="true"></i></span>
								</div>
							</div>
						<?php } ?>
					</div>
					...
					<div class="col-12 col-md-6 col-lg-8 col-xl-8">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title d-inline-block">Agências</h4> <a href="agency.php" class="btn btn-primary float-right">Ver todas</a>
							</div>
					...
					<div class="col-12 col-md-6 col-lg-4 col-xl-4">
						<div class="card member-panel">
							...
							<div class="card-footer text-center bg-white">
								<!-- <a href="add_user" class="text-muted">Adicionar Usuários</a> -->
							</div>
						</div>
					</div>
				</div>
