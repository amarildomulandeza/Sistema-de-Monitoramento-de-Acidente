<div class="header">
    <div class="header-left">
        <a href="#" class="logo">
            <img src="assets/img/logo.png" width="35" height="35" alt=""> <span>SMAT</span>
        </a>
    </div>
        ...
        ?>
            ...
            <div class="dropdown-menu notifications">
                ...
                <div class="drop-scroll">
                    ...
                    <?php
                    $result = $db->prepare("SELECT e.*, a.agency_name FROM emergency e INNER JOIN agency a ON e.agency_id = a.agency_id WHERE status = 'Pendente' ORDER BY id DESC ");
                    $result->execute();
                    for ($i = 0; $row = $result->fetch(); $i++) {
                    ?>
                ...
                <div class="topnav-dropdown-footer">
                    <a href="view-emergency.php">Ver todas Emergências</a>
                </div>
            </div>
            </li>
