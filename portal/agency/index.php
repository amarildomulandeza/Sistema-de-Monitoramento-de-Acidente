			...
			<div class="content">
				<div class="row">
						...
						?>
							<div class="dash-widget">
								...
								<div class="dash-widget-info text-right">
									...
									<span class="widget-title1">Casos de Emergência<i class="fa fa-check" aria-hidden="true"></i></span>
								</div>
							</div>
						<?php } ?>
					</div>
					...
					<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
						<?php
						// include('../connect.php');
						$result = $db->prepare("SELECT count(*) as total FROM emergency WHERE agency_id = {$_SESSION['SESS_AGENCY_ID']} AND status = 'Resolvido' ");
						$result->execute();
						for ($i = 0; $row = $result->fetch(); $i++) {
						?>
							<div class="dash-widget">
								...
								<div class="dash-widget-info text-right">
									<h3><?php echo $row['total']; ?></h3>
									<span class="widget-title2">Resolvidos <i class="fa fa-check" aria-hidden="true"></i></span>
								</div>
							</div>
						<?php } ?>
					</div>
					...
					<div class="col-12 col-md-6 col-lg-8 col-xl-8">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title d-inline-block">Todas as Agências</h4>
							</div>
